    ...
    def _query(self, with_clause='', fields={}, groupby='', from_clause=''):
        ...
        select_ = """
            SELECT
                ...
                pt.primary_location as primary_location,
            ...
            FROM
                ...
                LEFT JOIN stock_quant pq ON pq.product_id = pp.id AND pq.location_id = pt.primary_location
            WHERE
...
#                 p.primary_location as primary_location,
...
#             WHERE
#                 q.location_id = p.primary_location AND
#                 q.quantity <= 0
#             GROUP BY
